                    ...
                    <div class="content_wrap">
                        ...
                        <div class="content">
                            <div class="list_products shop_mode_thumbs">
                                ...
                                <ul class="products">
                                    <!-- Product item -->
                                    <?php if(is_array($Data)): foreach($Data as $key=>$vo): ?><li class="product column-1_3 first">
                                        <div class="post_item_wrap">
                                            <div class="post_featured">
                                                <div class="post_thumb hover_icon">
                                                    <img src="<?php echo ($vo["medart_pic"]); ?>" alt="" title="god-is-love-tshirt" />
                                                    <a href="<?php echo U('Ophtha/center',array('medart_id' => $vo['medart_id']));?>" class="button add_to_cart_button">查看详情</a>
                                                </div>
                                            </div>
                                            <h3>
                                                <a href="<?php echo U('Ophtha/center',array('medart_id' => $vo['medart_id']));?>"><?php echo ($vo["medart_title"]); ?></a>
                                            </h3>
                                            <div class="op_sj">
                                            	<span class="post_info_item post_info_counters"><?php echo ($vo["medart_time"]); ?></span>
                                            </div>
                                        </div>
                        ...
                        <div class="sidebar widget_area scheme_original">
                            <div class="sidebar_inner widget_area_inner">
                                    ...
                                    <?php if(is_array($art)): foreach($art as $key=>$vo): ?><article class="post_item with_thumb first">
                                            ...
                                            <div class="post_content">
                                                ...
                                                <span class="post_info_item">
                                                    ...
                                                    <a href="javascript:;" class="post_info_date"><?php echo ($vo["medart_time"]); ?> </a>
                                ...
                                <aside class="widget woocommerce widget_product_categories">
                                    ...
                                    <ul class="product-categories">
                                        <?php if(is_array($cateData)): foreach($cateData as $key=>$vo): ?><li>
                                            <a href="<?php echo U('Ophtha/index', array('category_id' => $vo['category_id']));?>"><?php echo ($vo["category_name"]); ?></a>
                                ...
                                <aside class="widget woocommerce widget_product_tag_cloud">
                                    ...
                                    <div class="tagcloud">
                                        <?php if(is_array($tagData)): foreach($tagData as $key=>$vo): ?><a href="<?php echo U('Ophtha/index', array('tag_id' => $vo['tag_id']));?>" title="3 products"><?php echo ($vo["tag_name"]); ?></a><?php endforeach; endif; ?>
                                    </div>
                                </aside>
                                <!-- /Widget: Product Tag Cloud -->
