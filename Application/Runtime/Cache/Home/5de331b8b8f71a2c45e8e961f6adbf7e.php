                    ...
                    <div class="content_wrap">
                        ...
                        <div class="content">
                            <div class="list_products shop_mode_thumbs">
                                ...
                                <ul class="products">
                                    <!-- Product item -->
                                    <?php if(is_array($Data)): foreach($Data as $key=>$vo): ?><li class="product column-1_4 first">
                                        <div class="post_item_wrap">
                                            <div class="post_featured">
                                                <div class="post_thumb hover_icon">
                                                    <img src="<?php echo ($vo["his_pic"]); ?>" alt="" title="god-is-love-tshirt" />
                                                    <a href="<?php echo U('History/deta',array('his_id' => $vo['his_id']));?>" class="button add_to_cart_button">查看详情</a>
                                                </div>
                                            </div>
                                            <h3>
                                                <a href="<?php echo U('History/deta',array('his_id' => $vo['his_id']));?>"><?php echo ($vo["his_title"]); ?></a>
                                            </h3>
                                            <div class="op_sj">
                                            	<span class="post_info_item post_info_counters"><?php echo ($vo["his_time"]); ?></span>
                                            </div>
                                        </div>
