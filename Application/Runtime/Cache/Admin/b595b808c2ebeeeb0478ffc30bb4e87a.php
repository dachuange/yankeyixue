		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="<?php echo U('Scheme/add');?>">
							添加文章</a>
						</li>
						<li>
							<a href="<?php echo U('Scheme/index');?>">
							文章列表</a>
						</li>
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="<?php echo U('Cas/add');?>">
							添加新闻</a>
						</li>
						<li>
							<a href="<?php echo U('Cas/index');?>">
							案例列表</a>
						</li>
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li>
							<a href="<?php echo U('Userinfor/index');?>">
							需救助人员列表</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li>
							<a href="<?php echo U('Peruser/index');?>">
							注册用户信息列表</a>
						</li>
					</ul>
				</li>
				...
				<!--<li>-->
					...
					<!--<ul class="sub-menu">-->
						...
						<!--</li>-->
						<!--<li>-->
							<!--<a href="<?php echo U('Facuser/index');?>">-->
							<!--厂家用户信息列表</a>-->
						<!--</li>-->
					<!--</ul>-->
				<!--</li>-->
				...
				<!--<li>-->
					<!--<a href="javascript:;">-->
						<!--<i class="icon-briefcase"></i>-->
						<!--<span class="title">厂家竞价信息</span>-->
						<!--<span class="arrow "></span>-->
					<!--</a>-->
					<!--<ul class="sub-menu">-->
						<!--<li>-->
							<!--<a href="<?php echo U('Quote/add');?>">-->
							<!--添加竞价信息</a>-->
						<!--</li>-->
						<!--<li>-->
							<!--<a href="<?php echo U('Quote/index');?>">-->
							<!--竞价信息列表</a>-->
						<!--</li>-->
					<!--</ul>-->
				<!--</li>	-->
