		...
		return {
			...
			destroy: function() {
				return this.each(function() {
					...
					}), d.$path.removeClass(d.hoverClass + " " + b.bcClass).addClass(d.pathClass), c.find("." + d.hoverClass).removeClass(d.hoverClass), d.onDestroy.call(c), void c.removeData("sf-options"))
				})
			},
			init: function(c) {
				return this.each(function() {
